...
import { RevocableRateOffer, RevocableRateOfferExternal } from "../instructions/RevocableRateOffer.sol";

contract AquaOpcodes is RevocableRateOfferExternal {
    ...
    function _runOpcode(Context memory ctx, uint256 opcode, bytes calldata args) internal virtual {
        ...
        else if (opcode == RevocableRateOffer.opcode.asU8()) RevocableRateOffer.exec(ctx, args);
