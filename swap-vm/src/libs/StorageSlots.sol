...
library StorageSlots {
    ...
    // keccak256(abi.encode(uint256(keccak256("1inch.storage.RevocableRateOffer")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 internal constant RevocableRateOffer = 0xfba01d34223bf61d4ab67fba767383020a34ac4ec11d22cdf30745f64588f700;
}
